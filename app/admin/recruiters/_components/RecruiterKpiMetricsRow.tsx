...
interface RecruiterKpiMetricsRowProps {
...
export function RecruiterKpiMetricsRow({
  totalRecruiters,
  verifiedCompaniesCount,
  totalDrivesCount,
  filteredCount,
}: RecruiterKpiMetricsRowProps) {
  const kpiItems = [
    {
      id: 'recruiters',
      title: 'Total Recruiters',
      value: totalRecruiters.toString(),
      trend: `${filteredCount} Active`,
      subtext: 'Campus talent leads',
      icon: Users,
    ...
    },
    {
      ...
      value: verifiedCompaniesCount.toString(),
      trend: 'Accredited',
      subtext: 'Verified corporate network',
      icon: Building2,
    ...
    },
    {
      ...
      value: totalDrivesCount.toString(),
      trend: 'Season 2026',
    ...
    },
    {
      ...
      value: '100%',
      trend: 'Auth Verified',
      subtext: 'Role-based credentials',
      icon: ShieldCheck,
