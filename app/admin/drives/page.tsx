    ...
    <div className="p-4 sm:p-6 lg:p-8 xl:p-10 w-full max-w-[1700px] mx-auto space-y-5 sm:space-y-6 xl:space-y-8 transition-all duration-300 ease-in-out">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3.5 sm:gap-4 pb-4 sm:pb-5 border-b border-slate-200">
        <div className="flex items-start sm:items-center gap-3">
          <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-blue-50 text-[#2563EB] border border-blue-200 shadow-2xs shrink-0">
        ...
        <div className="relative w-full sm:w-80 shrink-0">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white py-2 sm:py-2.5 pl-10 pr-4 text-xs sm:text-sm text-[#0A2540] focus:border-[#2563EB] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 font-medium shadow-xs"
          />
        </div>
      </div>

      {/* Drives Table */}
      <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-6 xl:p-8 shadow-xs">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-12 sm:py-20 text-slate-400">
            ...
            <p className="text-xs sm:text-sm font-semibold">Loading placement drives...</p>
          </div>
        ) : filteredPlacementDrives.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 sm:py-20 text-center">
            <Briefcase className="h-12 w-12 text-slate-300 mb-2" />
            <h3 className="text-sm sm:text-base font-bold text-[#0A2540]">No Placement Drives Found</h3>
            <p className="text-xs sm:text-sm text-slate-500 mt-1">Recruiter job drives and campus hiring openings will appear here.</p>
          </div>
        ) : (
                  ...
                  <tr key={drive.id} className="hover:bg-slate-50/80 transition-colors">
                    <td className="py-4 xl:py-5 pr-4">
                      <div className="flex items-center gap-3 xl:gap-4">
                        <div className="h-10 w-10 xl:h-12 xl:w-12 shrink-0 overflow-hidden rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-center font-bold text-xs xl:text-sm text-[#2563EB] shadow-2xs">
                        ...
                        <div>
                          <p className="font-bold text-[#0A2540] text-sm sm:text-base xl:text-lg">{drive.title}</p>
                    ...
                    <td className="py-4 xl:py-5 pr-4 text-slate-600 font-medium">
                      <div className="flex items-center gap-1.5">
                        <Building2 className="h-3.5 w-3.5 xl:h-4 xl:w-4 text-slate-400" />
                        <span>{drive.college?.name || 'All Campuses'}</span>
                      </div>
                    </td>

                    <td className="py-4 xl:py-5 pr-4">
                      <span className="font-mono font-bold text-[#2563EB] bg-blue-50 px-2.5 xl:px-3 py-1 rounded-md border border-blue-200 text-xs sm:text-sm xl:text-base">
                        {drive.salaryPackage}
                      </span>
                    </td>
                    ...
                    <td className="py-4 xl:py-5 pr-4">
                      <div className="flex items-center gap-1.5 text-[#0A2540] font-bold">
                        <Users className="h-3.5 w-3.5 xl:h-4 xl:w-4 text-slate-400" />
                    ...
                    <td className="py-4 xl:py-5 pr-4 text-slate-600 font-medium">
                      <div className="flex items-center gap-1.5">
                        <Calendar className="h-3.5 w-3.5 xl:h-4 xl:w-4 text-slate-400" />
