    ...
    <div className="rounded-2xl sm:rounded-3xl bg-white border border-slate-200/90 p-4 sm:p-5 lg:p-6 shadow-2xs flex flex-col justify-between space-y-3 sm:space-y-4">
      ...
      {locationItems.length > 0 ? (
        ...
        <div className="py-8 text-center space-y-2">
          <p className="text-xs font-bold text-slate-400">No regional location breakdown yet</p>
          <p className="text-[11px] text-slate-400 max-w-xs mx-auto">
            Location metrics populate automatically based on job locations and released offers.
          </p>
        </div>
      )}
