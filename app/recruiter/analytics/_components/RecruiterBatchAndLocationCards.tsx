...
import { MapPin, ChevronRight, GraduationCap, Building } from 'lucide-react';
import { BatchYearItem, LocationBreakdownItem } from '@/store/useRecruiterAnalyticsStore';

interface RecruiterBatchAndLocationCardsProps {
  batchYears: BatchYearItem[];
  locations: LocationBreakdownItem[];
}

export function RecruiterBatchAndLocationCards({
  batchYears,
  locations,
}: RecruiterBatchAndLocationCardsProps) {
  ...
  return (
    <div className="contents">
      ...
      {/* 1. Placement by Batch Year Card */}
          ...
          {batchItems.map((batch) => (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                <span className="p-1.5 rounded-xl bg-blue-50 text-blue-600 shrink-0 shadow-2xs">
      ...
      {/* 2. Offers by Location Card (Clean City List & Progress Indicators) */}
      <div className="rounded-2xl sm:rounded-3xl bg-white border border-slate-200/90 p-4 sm:p-5 lg:p-6 shadow-2xs flex flex-col justify-between space-y-3 sm:space-y-4">
