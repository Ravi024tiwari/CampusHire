...
export const DEMO_JOBS: RecruiterJobItem[] = [
  {
    ...
    responsibilities: [
      'Design, develop, and maintain high-throughput microservices and full-stack applications.',
      'Collaborate with cross-functional teams to build and ship impactful user-facing features.',
      'Write clean, efficient, robust, and well-tested code following best engineering practices.',
    ],
    minCgpa: 7.5,
  ...
  },
  {
    ...
    responsibilities: [
      'Develop scalable cloud components and APIs across Azure infrastructure.',
      'Write unit tests and automate integration test suites.',
      'Work alongside senior staff engineers on AI service optimization.',
    ],
    minCgpa: 8.0,
  ...
  },
  {
    ...
    responsibilities: [
      'Build resilient distributed backends with high throughput and low latency.',
      'Design modular microservices and event-driven architectures.',
  ...
  },
  {
    ...
    responsibilities: [
      'Analyze product engagement funnels and user retention metrics.',
      'Build executive dashboards and data pipelines for leadership visibility.',
      'Partner with UX and engineering teams on A/B experiments.',
    ],
    minCgpa: 7.0,
  ...
  },
  {
    ...
    responsibilities: [
      'Train deep learning models for catalog ranking and search personalization.',
