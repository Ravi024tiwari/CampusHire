  ...
  return (
    <header className="sticky top-0 z-30 flex flex-col border-b border-slate-200/90 bg-white/95 backdrop-blur-md transition-all shadow-2xs shrink-0">
      <div className="flex h-16 sm:h-[4.5rem] w-full items-center justify-between px-3 sm:px-6 gap-3">
        ...
        {/* Left: Mobile Toggle & Brand Emblem on Mobile/Tablet */}
        <div className="flex items-center gap-2.5 sm:gap-3.5 shrink-0">
          ...
          {/* CampusHire Official Logo on Mobile/Tablet (Sidebar has it on desktop) */}
          <Link 
            href="/recruiter/dashboard" 
            className="flex lg:hidden items-center gap-2 select-none outline-none group"
          >
            <div className="relative w-8 h-8 rounded-xl overflow-hidden shadow-2xs border border-slate-200/80 bg-white p-0.5 flex-shrink-0">
              <Image
            ...
            <span className="font-extrabold tracking-tight text-base font-heading leading-none flex items-center">
